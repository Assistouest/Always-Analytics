	...
	<div class="aa-header">
		<h1>
			<img src="<?php echo esc_url( AA_PLUGIN_URL . 'always-analytics.svg' ); ?>"
				 alt="Always Analytics Logo" class="aa-logo-img">
	...
	<div class="aa-kpis" id="aa-kpis">
		...
		<div class="aa-kpi-card" data-metric="engagement_rate">
			...
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=always-analytics-engagement' ) ); ?>"
			   class="aa-kpi-more-link">
				<?php esc_html_e( "Plus d'infos →", 'always-analytics' ); ?>
			</a>
		</div>
	</div>
	...
	<div id="aa-campaign-modal" class="aa-modal" aria-modal="true" role="dialog">
		...
		<div class="aa-modal-box">
			<div class="aa-modal-header">
				...
				<button class="aa-modal-close" aria-label="<?php esc_attr_e( 'Fermer', 'always-analytics' ); ?>"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg></button>
			</div>
			<div class="aa-modal-body">
				...
				<div id="aa-camp-error" class="aa-camp-error aa-camp-error--hidden"></div>
			</div>
				...
				<table class="aa-table aa-table--compact" id="aa-recent-visitors">
					<thead>
						<tr>
							...
							<th class="aa-col-right"><?php esc_html_e( 'Action', 'always-analytics' ); ?></th>
						</tr>
					</thead>
					<tbody></tbody>
				</table>
		...
		<div class="aa-card" id="aa-campaigns-card">
			...
			<div class="aa-card-body">
				<div id="aa-campaigns-list">
					<p class="aa-no-data aa-no-data--hidden"><?php esc_html_e( 'Aucun événement enregistré.', 'always-analytics' ); ?></p>
				</div>
			</div>
		</div>
	...
	<div id="aa-campaign-edit-modal" class="aa-modal" aria-modal="true" role="dialog">
		...
		<div class="aa-modal-box">
			...
			<div class="aa-modal-body">
				...
				<div id="aa-edit-camp-error" class="aa-camp-error aa-camp-error--hidden"></div>
			</div>
			<div class="aa-modal-footer">
